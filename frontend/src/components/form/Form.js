...
const Form = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost:8000/api/form-detail-view/', body, config)
            .then(res => {
                        ...
                        <div class="container" >
                            ...
                            <div>
                                ...
                                <div className="row" style={{ textAlign: 'center' }}>
                                    <button class="button-6" disabled={selectedSector === null || inputName.length === 0 || term === false} onClick={(e) => handleSubmit(e)} >Submit</button>
                                </div>
